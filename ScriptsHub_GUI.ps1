...
$FirstRunBtn2                       = New-Object system.Windows.Forms.Button
$FirstRunBtn2.text                  = "...or just save to Desktop"
$FirstRunBtn2.width                 = 350
$FirstRunBtn2.height                = 30
$FirstRunBtn2.location              = New-Object System.Drawing.Point(55,285)
$FirstRunBtn2.Font                  = 'Tahoma,10'
$FirstRunBtn2.Visible               = $FirstRun
...
$Seperator2, $WarningLabel, $NetTestStartBtn, $NetTestLbl, $NetTextbox, $NetInfoLbl, $FirstRunInput1, $FirstRunInput2, $FirstRunLabel1, $FirstRunLabel2, $FirstRunBtn1, $FirstRunBtn2))
...
$FirstRunBtn1.Add_Click({
    ...
    $FirstRunBtn2.Visible            = $false
})

$FirstRunBtn2.Add_Click({
    $Seperator2.Visible              = $true
    $MainLabel.Visible               = $true
    $PCNamesLabel.Visible            = $true
    $CommaLabel.Visible              = $true
